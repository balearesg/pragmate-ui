...
export const getCSSCustomPropIndexFromStylesheet = (stylesheetHref: string): Array<[string, string]> => {
...
export const getCSSCustomPropsObjectFromStylesheet = (stylesheetHref: string): { [key: string]: string } => {
