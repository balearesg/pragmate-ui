	...
	return (
		< >
			...
			<div className="hero">
				...
				<p className="hero__description">Lorem ipsum dolor sit amet consectetur adipisicing elit. Id mollitia </p>
			</div>
			...
			<div className="wrapper">
				<div className="installation">
					...
					<div className="tab__container">
						<ul className="tab__menu">
							<li className="tab active" data-tab="mac">npm</li>
							<li className="tab" data-tab="linux">yarn</li>
						</ul>
				...
				<div className="feature">
					...
					<div className="feature__item">
						<h3 className="section__title">Lorem ipsum</h3>
						<p>For better readability, bgroup/ui has a clean, beautiful color scheme allow you to scan files fast.</p>
					</div>
					<div className="feature__item">
						<h3 className="section__title">Lorem ipsum</h3>
						<p>You can expect common keybindings for bgroup/ui. Customize <span className="code code--inline">bindings.json</span> for your own liking! </p>
					</div>
				</div>
			...
			<div className="changelog">
				<div className="wrapper">
					...
					<div className="changelog__callout">
						<a href="#" className="button--secondary">Checkout Full Log</a>
					</div>
				</div>
			</div>
