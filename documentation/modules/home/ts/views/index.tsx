    ...
    <>
      ...
      <div className="hero">
        <div className="container">
          <h1 className="hero__title">pragmate-ui</h1>
          <p className="hero__description mt-30">
            Welcome to pragmate-ui, the home of intuitive and reusable UI
            components. Our library has been crafted with care to streamline
            your development process, providing a diverse range of components
            that are easy to implement. Explore, import, and create with
            pragmate-ui.
          </p>
        </div>
      </div>
      ...
      t<footer className="footer">pragmate-ui MIT license </footer>
    </>
  );
}
