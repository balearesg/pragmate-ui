...
function View() {
	return (
		<div className="view">
			...
			<p className="view__p">
				El componente <span className="view__span">Input</span> Nos permite agregar elementos input a nuestra
				aplicacion con la especialidad de poder agregar si deseamos o necesitamos como atributos un label
				definido,icono, un disable, contraseña con icono de ocultar y un spinner.
			</p>
			<div className="component-info">
				<h3>Import:</h3>
				<Code>{`import { Input } from 'simply-ui/form';`}</Code>
