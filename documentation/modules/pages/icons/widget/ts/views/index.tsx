  ...
  return (
    <div className="view">
      ...
      <p className="view__p">
        ...
        sistema operativo o un ícono personalizado. Contamos con iconos normales
        y botones iconos. Excelente componente para facilitar la comunicación
        visual en una interfaz de usuario, ayudando a los usuarios a comprender
        rápidamente el propósito de un botón o enlace. tambien mejora la
        apariencia y el atractivo, Los iconos pueden mejorar la apariencia de
        una aplicación, haciendo que se vea más interesante y atractivo.
      </p>
